...
<body class="bg-gray-100 min-h-screen">
    ...
    <main class="max-w-7xl mx-auto px-4 py-6">
        ...
        <div id="stats" class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            ...
            <div class="bg-white rounded-lg shadow p-4">
                <div id="stat-sources" class="text-3xl font-bold text-purple-600">6</div>
        ...
        <div class="bg-white rounded-lg shadow p-4 mb-6">
            <div class="flex flex-wrap gap-2" id="filters">
                ...
                <button onclick="filterBySource('saramin')" class="source-btn px-4 py-2 rounded-full text-sm font-medium bg-gray-100 text-gray-700 hover:bg-gray-200">사람인</button>
                <button onclick="filterBySource('jobkorea')" class="source-btn px-4 py-2 rounded-full text-sm font-medium bg-gray-100 text-gray-700 hover:bg-gray-200">잡코리아</button>
                <button onclick="filterBySource('wanted')" class="source-btn px-4 py-2 rounded-full text-sm font-medium bg-gray-100 text-gray-700 hover:bg-gray-200">원티드</button>
                <button onclick="filterBySource('rocketpunch')" class="source-btn px-4 py-2 rounded-full text-sm font-medium bg-gray-100 text-gray-700 hover:bg-gray-200">로켓펀치</button>
                <button onclick="filterBySource('linkedin')" class="source-btn px-4 py-2 rounded-full text-sm font-medium bg-gray-100 text-gray-700 hover:bg-gray-200">LinkedIn</button>
                <button onclick="filterBySource('jobtalio')" class="source-btn px-4 py-2 rounded-full text-sm font-medium bg-gray-100 text-gray-700 hover:bg-gray-200">공공기관</button>
            </div>
        </div>
